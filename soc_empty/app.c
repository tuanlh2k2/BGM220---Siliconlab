...
uint32_t integer_humi_value, decimal_humi_value, integer_temp_value, decimal_temp_value;
...
SL_WEAK void app_process_action(void)
{
	if (flag == true) {
		flag = false;
		dht11_status_t sc;
		sc = readDataDHT11(&integer_humi_value, &decimal_humi_value, &integer_temp_value, &decimal_temp_value);
		if (sc == DHT11_OK) {
