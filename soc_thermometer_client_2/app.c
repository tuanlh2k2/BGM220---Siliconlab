...
void sl_bt_on_event(sl_bt_msg_t* evt)
{
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_bt_evt_scanner_scan_report_id:
    	app_log("sl_bt_evt_scanner_scan_report_id\n");
    ...
    case sl_bt_evt_gatt_service_id:
    	app_log("sl_bt_evt_gatt_service_id\n");
    ...
    case sl_bt_evt_gatt_procedure_completed_id:
    	app_log("sl_bt_evt_gatt_procedure_completed_id\n");
    ...
    case sl_bt_evt_gatt_characteristic_value_id:
    	app_log("sl_bt_evt_gatt_characteristic_value_id\n");
    ...
    case sl_bt_evt_connection_rssi_id:
    	app_log("sl_bt_evt_connection_rssi_id\n");
